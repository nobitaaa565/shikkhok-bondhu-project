...
import Storybook from '../components/LilysStory';
...
const StorybookPage: React.FC<StorybookPageProps> = ({ userRole, onLogout, onLogin }) => {
    ...
    // Sync theme attribute when page mounts
    useEffect(() => {
    ...
    return (
        ...
        >
            {/* Background Video — only shown in dark mode */}
            {!isLight && (
                <>
                    <video
            ...
            {/* Footer with light-mode aware background */}
            <div
